 ...
 */
?>
<style>.embedded_video{position:relative;height:0;padding-bottom:56.25%;margin:10px auto}.videoframe{position:absolute;top:0;left:0;width:100%;height:100%}</style>
<script>
