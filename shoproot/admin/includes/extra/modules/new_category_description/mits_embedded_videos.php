  ...
  <div class="main" style="margin-top:10px;padding:3px;">
    <div style="border:1px solid #aaa;background:#ffe;">
      ...
      <div class="mits_embedded_videos">
        <?php
        $videos = mits_get_categories_videos($cInfo->categories_id, $languages[$i]['id']);
        for ($v = 1, $cv = $countVideoFields; $v < $cv; $v++) {
          ?>
          <div style="padding: 5px 0;">
            <table class="tableInput">
              ...
              <tr>
                ...
                <td>
                  <span class="main"><?php echo xtc_draw_pull_down_menu('video_position_' . $v . '_' . $languages[$i]['id'], $video_position, (isset($videos[$v]['video_position']) ? $videos[$v]['video_position'] : 1), ''); ?></span>
                </td>
              </tr>
              <tr>
